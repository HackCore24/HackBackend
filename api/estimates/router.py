...
@estimates_router.patch('/chapter/{chapter_id}', response_model=ChapterRead)
...
@estimates_router.post('/service/', name="Create chapter", response_model=ServiceRead)
...
@estimates_router.get('/service/', name="Get All chapters", response_model=List[ServiceRead])
async def get_all_services(services=services_service, me=Depends(get_me)):
    return await services.all_services()


@estimates_router.get('/service/chpater/{chapter_id}', name="Get chapter By id", response_model=List[ServiceRead])
async def get_service_by_id(chapter_id: str, services=services_service, me=Depends(get_me)):
    return await services.chapter(chapter_id)


@estimates_router.get('/service/{service_id}', name="Get chapter By id", response_model=ServiceRead)
...
@estimates_router.patch('/service/{service_id}', response_model=ServiceRead)
